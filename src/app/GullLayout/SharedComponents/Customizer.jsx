...
import {
  handleWidget
} from "app/redux/actions/WidgetActions";
...
class Customizer extends Component {
  ...
  clickWidget = event => {
    let { handleWidget } = this.props;
    handleWidget(merge({}, this.state.widget, {
                ...
                <div className="card-body">
                  <label className="checkbox checkbox-primary">
                    <input
                      type="checkbox"
                      id="widget1"
                      checked={this.state.widget.handleState}
                      onChange={this.clickWidget}
                    />
                    <span>Widget-1</span>
                    <span className="checkmark"></span>
                  </label>
...
Customizer.propTypes = {
  ...
  handleWidget: PropTypes.func.isRequired,
